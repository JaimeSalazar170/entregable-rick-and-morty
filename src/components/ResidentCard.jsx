  ...
  console.log(resident);  
    ...
    <article className = 'resident'>
      ...
      <ul className = 'resident__list'>
        <li className = 'resident__item'><span>Specie </span><span>{ResidentCard?.species}</span></li>
        <li className = 'resident__item'><span>Origen </span><span>{resident?.origin.name}</span></li>
